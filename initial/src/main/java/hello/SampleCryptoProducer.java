...
public class SampleCryptoProducer {
    ...
    public static void main(String[] args) throws PulsarClientException, InterruptedException, IOException {
        ...
        class RawFileKeyReader implements CryptoKeyReader {
            ...
            public EncryptionKeyInfo getPublicKey(String keyName, Map<String, String> keyMeta) {
                ...
                try {
                    ...
                    if( keyName.equals("myappkey")) {
                        System.out.println("Reading key from publicKeyFile");
                        keyInfo.setKey(Files.readAllBytes(Paths.get(publicKeyFile)));
                    } else {
                        System.out.println("Reading key from publicKeyFile2");
                        keyInfo.setKey(Files.readAllBytes(Paths.get("test2_ecdsa_pubkey.pem")));
                    }
                } catch (IOException e) {
            ...
            public EncryptionKeyInfo getPrivateKey(String keyName, Map<String, String> keyMeta) {
                ...
                try {
                    ...
                    if( keyName.equals("myappkey")) {
                        System.out.println("Reading key from privateKeyFile");
                        keyInfo.setKey(Files.readAllBytes(Paths.get(privateKeyFile)));
                    } else {
                        System.out.println("Reading key from privateKeyFile2");
                        keyInfo.setKey(Files.readAllBytes(Paths.get("test2_ecdsa_privkey.pem")));
                    }
                } catch (IOException e) {
        ...
        prodConf.addEncryptionKey("myappkey2");
